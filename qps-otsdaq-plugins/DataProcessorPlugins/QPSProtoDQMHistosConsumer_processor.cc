#include "otsdaq-demo/DataProcessorPlugins/QPSProtoDQMHistosConsumer.h"
...
//==============================================================================
QPSProtoDQMHistosConsumer::QPSProtoDQMHistosConsumer(
    ...
    , DQMFilePrefix_(theXDAQContextConfigTree.getNode(configurationPath)
                         ...
                         .getValue<std::string>())
    , dqmHistos_(new QPSProtoDQMHistos())

{
}

//==============================================================================
QPSProtoDQMHistosConsumer::~QPSProtoDQMHistosConsumer(void) { closeFile(); }

//==============================================================================
void QPSProtoDQMHistosConsumer::startProcessingData(std::string runNumber)
{
	// IMPORTANT
...
//==============================================================================
void QPSProtoDQMHistosConsumer::stopProcessingData(void)
{
...
//==============================================================================
bool QPSProtoDQMHistosConsumer::workLoopThread(toolbox::task::WorkLoop* /*workLoop*/)
{
...
//==============================================================================
void QPSProtoDQMHistosConsumer::fastRead(void)
{
...
//==============================================================================
void QPSProtoDQMHistosConsumer::slowRead(void)
{
...
DEFINE_OTS_PROCESSOR(QPSProtoDQMHistosConsumer)
